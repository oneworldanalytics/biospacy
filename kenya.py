...
from ken.data_preview import dataset_preview
from ken.download_demo_csv import get_binary_file_downloader_html
from ken.get_download_link import get_table_download
from ken.home import home_page


class kenya_app(HydraHeadApp):
    def run(self):
        ...
        new_title = '<p style="font-family:chilanka; font-size: 40px;">Kenya Biospacy Model</p>'
        ...
        **Biospacy Kenya** is a country package that is trained to recognise terms and places from South Africa.
        **Biospacy Kenya** is under active development and this is simply a demonstration.
