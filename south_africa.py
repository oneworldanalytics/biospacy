...
from za.data_preview import dataset_preview
from za.download_demo_csv import get_binary_file_downloader_html
from za.get_download_link import get_table_download
from za.home import home_page


class south_app(HydraHeadApp):
    def run(self):
        ...
        new_title = '<p style="font-family:chilanka; font-size: 40px;">South Africa Biospacy Model</p>'
        ...
        **Biospacy South Africa** is a country package that is trained to recognise terms and places from South Africa.
        **Biospacy South Africa** is under active development and this is simply a demonstration.
