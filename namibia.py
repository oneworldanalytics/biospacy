...
from namib.data_preview import dataset_preview
from namib.download_demo_csv import get_binary_file_downloader_html
from namib.get_download_link import get_table_download
from namib.home import home_page


class namibia_app(HydraHeadApp):
    def run(self):
        ...
        new_title = '<p style="font-family:chilanka; font-size: 40px;">Namibia Biospacy Model</p>'
        ...
        **Biospacy Namibia** is a country package that is trained to recognise terms and places from South Africa.
        **Biospacy Namibia** is under active development and this is simply a demonstration.
