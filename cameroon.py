...
from came.data_preview import dataset_preview
from came.download_demo_csv import get_binary_file_downloader_html
from came.get_download_link import get_table_download
from came.home import home_page


class cameroon_app(HydraHeadApp):
    def run(self):
        ...
        new_title = '<p style="font-family:chilanka; font-size: 40px;">Cameroon Biospacy Model</p>'
        ...
        **Biospacy Cameroon** is a country package that is trained to recognise terms and places from South Africa.
        **Biospacy Cameroon** is under active development and this is simply a demonstration.
